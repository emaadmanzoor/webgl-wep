 ...
 */
var loadShader = function(gl, shaderType, shaderSource, opt_errorCallback) {
...
var createShaderFromScript = function(
  ...
  return loadShader(
      gl, opt_shaderType ? opt_shaderType : shaderType, shaderSource,
      opt_errorCallback);
};
...
this.createShaderFromString = loadShader;
